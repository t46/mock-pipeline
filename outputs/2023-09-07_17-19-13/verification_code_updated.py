...
questions = ["What is the capital of France?", "Who wrote 'To Kill a Mockingbird'?", "What is the color of the sky?"]  # list of questions that can be answered in one word
answers = ["Paris", "Harper Lee", "Blue"]  # corresponding list of one-word answers
