...
# Mock function to ask LLM
def ask_LLM(question):
    # This function should be replaced with the actual function to ask the LLM
    return random.randint(1, 200)  # Mock response
...
for problem in dataset:
    X, Y = problem
    response1 = ask_LLM(f"What is {X} + {Y}?")
